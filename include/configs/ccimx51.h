...
# define CONFIG_INITRD_LOAD_ADDR	0x91000000	/* 8MiB after the load address */
# define CONFIG_WCE_LOAD_ADDR		0x94000000	/* 64MiB offset of first bank */
#else
# define CONFIG_LOADADDR		0xa0000000	/* default load address	128MiB */
# define CONFIG_INITRD_LOAD_ADDR	0xa0800000	/* 8MiB after the load address */
# define CONFIG_WCE_LOAD_ADDR		0xa0000000	/* 128MiB offset of first bank  */
#endif
