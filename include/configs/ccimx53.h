...
# define CONFIG_INITRD_LOAD_ADDR	0x71000000	/* 8MiB after the load address */
# define CONFIG_WCE_LOAD_ADDR		0x74000000	/* 64MiB offset of first bank */
#else
# define CONFIG_LOADADDR		0xb0000000	/* default load address	*/
# define CONFIG_INITRD_LOAD_ADDR	0xb0800000	/* 8MiB after the load address */
# define CONFIG_WCE_LOAD_ADDR		0xb0000000	/* base address of second bank */
#endif
